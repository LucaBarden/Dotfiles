...
" makeprg set
autocmd Filetype cpp setlocal makeprg=g++\ %\ -o\ %<.out\ &&\ .\/%<.out
autocmd Filetype c setlocal makeprg=gcc\ %\ -lpthread\ -Wall\ -o\ %<.out\ &&\ .\/%<.out
autocmd Filetype py setlocal makeprg=python3\ %
